...
import com.example.cp.adapter.ChatAdapter
import com.example.cp.adapter.UserAdapter
import com.example.cp.model.Chat
...
class ChatActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imgProfile =  findViewById<CircleImageView>(R.id.imgProfile)
        imgBack = findViewById<ImageView>(R.id.imgBack)
        btnSendMessage = findViewById<ImageButton>(R.id.btnSendMessage)
        ...
        btnSendMessage.setOnClickListener {
            ...
            else
            {
                ...
                etMessage.setText("")
//                topic ="/topic/$userId"
//                PushNotification(Notification(userName!1,message),topic).also{
//                    sendNotification(it)
//                }
            }
        }
